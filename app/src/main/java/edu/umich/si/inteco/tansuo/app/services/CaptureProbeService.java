package edu.umich.si.inteco.tansuo.app.services;
...
import edu.umich.si.inteco.tansuo.app.util.ConfigurationManager;
import edu.umich.si.inteco.tansuo.app.util.FileHelper;
import edu.umich.si.inteco.tansuo.app.util.LogManager;
import edu.umich.si.inteco.tansuo.app.util.NotificationHelper;
import edu.umich.si.inteco.tansuo.app.util.PreferenceHelper;
...
import edu.umich.si.inteco.tansuo.app.util.TriggerManager;
...
public class CaptureProbeService extends Service {
    ...
    public static int LOCATION_UPDATE_INTERVAL_IN_SECONDS = 5 ;
    ...
    public static int LOCATION_UPDATE_INTERVAL =
            LOCATION_UPDATE_INTERVAL_IN_SECONDS  * GlobalNames.MILLISECONDS_PER_SECOND ;

    // The fastest update location frequency, in seconds
    public static final int FASTEST_LOCATION_UPDATE_INTERVAL_IN_SECONDS = 1;

    // A fast frequency ceiling in milliseconds
    public static final long FASTEST_LOCATION_UPDATE_INTERVAL =
            FASTEST_LOCATION_UPDATE_INTERVAL_IN_SECONDS * GlobalNames.MILLISECONDS_PER_SECOND;
    ...
    public void onCreate() {
        ...
        if ( PreferenceHelper.getPreferenceString(GlobalNames.SHARED_PREFERENCE_PROPERTY_DEVICE_ID, "NA").equals("NA")) {
            TelephonyManager mngr = (TelephonyManager)getSystemService(this.TELEPHONY_SERVICE);
            GlobalNames.DEVICE_ID = mngr.getDeviceId();
            PreferenceHelper.setPreferenceValue(GlobalNames.SHARED_PREFERENCE_PROPERTY_DEVICE_ID, mngr.getDeviceId());
        }
        else {
            GlobalNames.DEVICE_ID = PreferenceHelper.getPreferenceString(GlobalNames.SHARED_PREFERENCE_PROPERTY_DEVICE_ID, "NA");
        }
