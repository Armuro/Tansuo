...
import edu.umich.si.inteco.tansuo.app.util.VisualizationManager;
...
public class AnnotateActivity extends Activity implements OnItemSelectedListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        String mReviewMode = bundle.getString(ActionManager.ACTION_PROPERTIES_ANNOTATE_REVIEW_RECORDING, RecordingAndAnnotateManager.ANNOTATE_REVIEW_RECORDING_NONE);
        ...
        //we don't need to start a session, we have a session id from the intent
            ...
            Log.d(LOG_TAG, "[test start annotate recording] we don't need to start recording in the annotate Activity, the session id is " + mSessionId);
    ...
    private void setupViews() {
        ...
        submitButton.setOnClickListener(new View.OnClickListener(){
            ...
            public void onClick(View view) {
                ...
                //Log.d(LOG_TAG, "[AnnotateActivity] submit annotation set " + annotationSet.toJSONObject().toString());

                //associate annotationSet to the session
                RecordingAndAnnotateManager.addAnnotationToSession(annotationSet, mSessionId);


                //check if we will have users look at a list of recording
