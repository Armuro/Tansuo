...
public class QuestionnaireManager {
    ...
    public static String createDataContent(JSONObject dataJSON) {
        ...
        RemoteDBHelper.queryRemoteDB(RemoteDBHelper.DATA_TYPE_PHONE_LOG);
        RemoteDBHelper.queryRemoteDB(RemoteDBHelper.DATA_TYPE_BACKGROUND_RECORDING);
        RemoteDBHelper.queryRemoteDB(RemoteDBHelper.DATA_TYPE_SESSION_RECORDING);
                            ...
                            if (annotationSet!=null && annotationSet.getAnnotations()!=null){
                                ...
                                for (int j=0; j<annotationSet.getAnnotations().size(); j++){
                                    ...
                                    if (annotation.getTags().contains("Label")){
                                        ...
                                        //replace the tempalte with real value
                                        String label = annotation.getContent();
