...
import edu.umich.si.inteco.tansuo.app.model.ProbeObject;
...
import edu.umich.si.inteco.tansuo.app.model.TriggerLink;
                        ...
                        if (condition.getType().equals(ConditionManager.CONDITION_TYPE_PROBE_TRANSPORTATION)) {
                          ...
                          //  Log.d(LOG_TAG, "[examineEventConditions] got " + ConditionManager.CONDITION_TYPE_PROBE_TRANSPORTATION );
                            ...
                            if (!ContextExtractor.isWifiConnected()) {
                                ...
                                Log.d(LOG_TAG, "[examineEventConditions] it's not under wifi, we can inspect transportation");
                                ...
                                if (record!=null) {
                                    ...
                                    Log.d(LOG_TAG, "[examineEventConditions], current transportation is " +
